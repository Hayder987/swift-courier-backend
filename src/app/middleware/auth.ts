  ...
  return catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (!id) {
      throw new AppError(
        ...
        "Invalid access token. User ID is missing.",
      );
    }
    ...
    if (!name) {
      throw new AppError(
        httpStatus.NOT_FOUND,
        "Invalid access token. Name is missing.",
      );
    }
    ...
    if (!email) {
      throw new AppError(
        httpStatus.NOT_FOUND,
        "Invalid access token. Email is missing.",
      );
    }
    ...
    if (!isEmailVerified) {
      throw new AppError(
        httpStatus.UNAUTHORIZED,
        "Invalid access token. Email Not Verified.",
      );
    }
    ...
    if (!role) {
      throw new AppError(
        httpStatus.NOT_FOUND,
        "Invalid access token. User role is missing.",
      );
    }
